  ...
  return (
    <>
      ...
      <Stack
        direction="row"
        spacing={2}
        sx={{ alignItems: 'center', flex: '0 0 auto', p: '24px', background: '#F1F1F4' }}
      >
        ...
        <OutlinedInput
          ...
          sx={{ flex: '1 1 auto', background: '#fff' }}
          value={content}
        />
      ...
      <Box sx={{ background: '#F9FAFB', p: '12px 0', textAlign: 'center' }}>
        {' '}
        <img src="/clientSideImages/wingmanLogo.svg" alt="wingmanLogo" width={58} height={12} />
      </Box>
    </>
  );
}
